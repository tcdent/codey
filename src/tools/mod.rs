...
pub mod names {
    ...
    pub const SHARED_TASK_LIST: &str = "mcp_shared_task_list";
}
...
pub use impls::{
    ...
    ReadFileTool, RecordCorrectionTool, SharedTaskListTool, ShellTool, SpawnAgentTool,
...
impl ToolRegistry {
    ...
    pub fn new() -> Self {
        ...
        registry.register(Arc::new(SharedTaskListTool));
